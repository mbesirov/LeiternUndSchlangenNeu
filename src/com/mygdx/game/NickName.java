 ...
 */
public class NickName implements Screen, InputProcessor {
    private Game game;
    private Stage stage;
    ...
    public void show() {
        ...
        header = new Label("Hier kommt ein Textfeld",ls);
        tb=new TextButton("Nick eingeben",tbs);
