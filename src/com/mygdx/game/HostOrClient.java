 ...
 */
public class HostOrClient implements Screen, InputProcessor {
    private Game game;
    private Stage stage;
    ...
    public void show() {
        ...
        TextButton tb2=new TextButton("Client",tbs);
        tb2.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new Client(game));
            }
        });
