...
//Schlange 69-33
        if((y > (theGameView.getHeight()-height-50-(theGameView.getHeight()/10)*6)-30 )&& (y < (theGameView.getHeight()-height-50-(theGameView.getHeight()/10)*6)+30 ) && (x>(theGameView.getWidth()/10*4 -30)-20 && x<(theGameView.getWidth()/10*4 -30)+20) ) {
